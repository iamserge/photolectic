...
export const metadata: Metadata = {
  ...
  description: "Understanding photo licensing options and usage rights on Photolectic.",
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="pt-32 pb-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-black tracking-tight mb-4">License Agreement</h1>
                    ...
                    {licenseComparison.map((item, i) => (
                      <tr key={i} className="border-b border-white/5">
                        ...
                        <td className="py-3 px-4 text-center">
                          {item.standard ? (
                            <Check className="inline-block text-emerald-400" size={18} />
                          ) : (
          ...
          <div className="prose prose-invert prose-amber max-w-none">
            <section className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                Upon purchase of a photo from Photolectic, the Licensor (photographer) grants
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground">
                All photos on Photolectic are verified as authentic human-made photography.
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                Photolectic and the photographer warrant that:
              </p>
              <ul className="list-disc pl-6 text-muted-foreground mb-4 space-y-2">
              ...
              <p className="text-muted-foreground">
                Photolectic&apos;s liability is limited to the purchase price of the license. We
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                the image. Photolectic may pursue legal remedies for unauthorized use.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                Email: licensing@photolectic.com<br />
                For enterprise licensing: enterprise@photolectic.com
              </p>
            </section>
          </div>
        </div>
