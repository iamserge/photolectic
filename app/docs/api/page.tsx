...
import { Code, Key, Zap, Shield, BookOpen, Terminal } from "lucide-react";

export const metadata: Metadata = {
  title: "API Documentation",
  description: "Integrate Photolectic's verified photography into your applications with our REST API.",
};
...
const response = await fetch('https://api.photolectic.com/v1/photos/search', {
  method: 'GET',
  headers: {
...
export default function ApiDocsPage() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground font-light">
              Integrate verified, authentic photography into your applications.
              Full REST API with authentication, search, and download capabilities.
            </p>
      ...
      <section className="border-t border-white/5 bg-black/30 py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold mb-6">Example: Search Photos</h2>
          <div className="stat-card">
            <pre className="bg-black/50 rounded-lg p-4 overflow-x-auto text-sm">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-2xl px-4 text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Get started with our API today. Full documentation and support included.
          </p>
