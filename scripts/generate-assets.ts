...
const logoPrompt = {
  prompt: "Minimalist logo design for photography brand called Photolectic, combining camera aperture blades with human eye iris, warm amber and gold gradient colors, sleek modern design, on pure black background, vector style clean lines, professional brand identity, symmetric, centered composition",
};
...
async function main() {
  console.log("\n╔══════════════════════════════════════════╗");
  console.log("║  Photolectic Asset Generator             ║");
